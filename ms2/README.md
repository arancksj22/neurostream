...
- `OPENAI_TRANSCRIPTION_SEGMENTS_PER_REQUEST`
- `WHISPER_MODEL`
- `MS3_BASE_URL`
- `MS4_BASE_URL`
...
- `OPENAI_TRANSCRIPTION_SEGMENTS_PER_REQUEST=2` or `3` to batch adjacent chunk WAV files into fewer Whisper requests
